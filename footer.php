...
<footer id="colophon" class="site-footer d-flex align-items-center" role="contentinfo">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- section1 -->
            <div class="col-4 footer_lines location_section centered-text">
            ...
            <!-- section2 -->
            <div class="col-4 footer_lines contactus_section centered-text">
            ...
            <!-- section3 -->
            <div class="col-4 ministries_section centered-text">
